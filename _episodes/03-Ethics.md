...
>
>   - [Open Brain Consent](http://open-brain-consent.readthedocs.io)
> project provides a collection of used consent forms which provision public sharing of collected data, and a suggested wording for an "ultimate" consent form which you could use in your studies.  Also points to the tools for data anonimization to prepare for public sharing.
>
